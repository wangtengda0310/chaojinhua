...
import com.igame.work.checkpoint.mingyunZhiMen.GateRankService;
...
public class GateRankHandler extends ReconnectedHandler {
	...
	private GateRankService gateRankService;
...
//		}else{
		myMrank = gateRankService.getMRank(player);
...
//		}
		...
		List<Ranker> mr = GateRankService.getRankList().get(player.getSeverId());
		if(mr == null){
