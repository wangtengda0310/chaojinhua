...
public class StringUtils {
	...
	public static void main(String[] args) {
		// String a = "ytrewq!@#$%^&*lkjhg";
		// byte[] writeStrUTF = writeStrUTF(a);
		// ChannelBuffer wrappedBuffer =
		// ChannelBuffers.wrappedBuffer(writeStrUTF);
		// // System.err.println(wrappedBuffer.readShort());
		// String readUTF = readUTF(wrappedBuffer);
		// System.err.println(readUTF);
		byte a = 0;
		int setValue = 0;
		for (int i = 0; i < 8; i++) {
			// String string = args[i];
			setValue = setValue(setValue, i, true);

		}
		setValue = setValue(setValue, 0, false);
		String toBinaryString = Integer.toBinaryString(setValue);
